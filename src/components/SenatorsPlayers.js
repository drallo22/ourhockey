...
function SenatorsPlayers() {
    ...
    const loadPlayersFromAPI = ()=>{
       ...
       axios.get('http://localhost:8082/api/teams/3/players')
       .then((response)=>{
    ...
    const addPlayer = (player)=>{
        ...
        axios.post('http://localhost:8082/api/teams/3/players', {
            'firstName' : firstName,
            'lastName' :lastName,
            'age' : age
        })
...
export default SenatorsPlayers;
